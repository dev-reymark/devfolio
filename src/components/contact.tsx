...
export default function Contacta() {
  ...
  return (
    <section>
      <div className="">
        <div className="max-w-6xl px-4 py-4 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div>
              ...
              <div className="mt-4 md:mb-12 max-w-2xl">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Contact me today for a consultation. I am excited to learn
                  about your project and start crafting your digital success
                  story.
                </p>
              </div>
              ...
              <blockquote className="hidden md:block relative max-w-sm">
                ...
                <div className="relative z-10">
                  <p className="text-xl italic text-gray-800 dark:text-white">
                    Join me, and together we can strengthen your brand like
                    never before!
                  </p>
                </div>
                    ...
                    <div className="mt-5">
                      ...
                      >
                        <Button
                          ...
                          as={Link}
                          href="tel:+639695151183"
                        >
                          <FaViber size={20} className="text-secondary" />
                          Quick Call
                        </Button>
                      </Tooltip>
          ...
          <div className="hidden sm:flex mt-6 md:mt-12 py-3 items-center text-sm text-gray-800 gap-x-1.5 after:flex-[1_1_0%] after:border-t after:border-gray-200 after:ms-6 dark:text-white dark:after:border-gray-700">
            ...
            about helping you stand out in the online world.
          </div>
        </div>
      </div>
    </section>
